...
function exportForClaude(topics, summaries, rawConvs, options) {
  ...
  md += `Generated by LANA AI on ${new Date().toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}.\n`;
...
function exportAsMarkdown(topics, summaries, rawConvs, options) {
  let md = `# LANA AI - Knowledge Export\n`;
